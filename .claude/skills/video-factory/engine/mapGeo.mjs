...
//     render time against the house palette. Raw hex is allowed only for map
//     grounds (water/land fills), where the palette has no equivalent.
...
export function validateGeo(geo) {
  ...
  for (const [i, el] of (geo.elements || []).entries()) {
    ...
    const need = {
      path: ["d"], line: ["a", "b"], drawPath: ["len"], flowDot: ["a", "b"],
      dot: ["x", "y"], pulseMarker: ["x", "y"], regionFill: ["clip"], blockMark: ["x", "y"],
    }[el.el];
    for (const f of need) {
...
export const GEO = {
  hormuz: {
    defs: [{ id: "w", from: "#12222c", to: "#0a1319" }, { id: "l", from: "#1d1811", to: "#12100c" }],
    bg: "url(#w)",
    elements: [
  ...
  drc: {
    defs: [{ id: "wd", from: "#12222c", to: "#0a1319" }, { id: "ld", from: "#1d1811", to: "#12100c" }],
    bg: "#080d11",
    elements: [
  ...
  saudi: {
    defs: [{ id: "w2", from: "#12222c", to: "#0a1319" }, { id: "l4", from: "#1d1811", to: "#12100c" }],
    bg: "#080d11",
