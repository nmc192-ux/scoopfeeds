...
export const STORYBOARD = {
  ...
  20: { card: "linechart", kicker: "Brent crude · 2026", title: "Then it kept going",
        ...
        ], yMin: 60, yMax: 140, yPrefix: "$",
        // The "$" used to be hardcoded inside the card. It is the caller's to
        // declare now, so this must be explicit or the axis silently loses it.
